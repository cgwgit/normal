    ...
    <body class="page-body">
        <div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->			
			...
			<div class="panel panel-default">
				<div class="row">
					<div class="col-md-12">
						<form role="form" class="form-horizontal" name="frm" action="/index.php/Home/Table/index/id/1" method="get">
							<div class="panel-body">
								<div class="form-group">
									...
									<select class="form-control" name="table">
									        ...
									        <?php if(is_array($tables)): foreach($tables as $key=>$vo): ?><option value="<?php echo ($key); ?>"><?php echo ($vo["table_comment"]); ?></option><?php endforeach; endif; ?>
				...
				<div class="row">					
					<div class="panel-body">
						<table class="table table-striped table-bordered" cellspacing="0" width="100%">
							...
							<tbody>
                               <?php if(is_array($wallet)): foreach($wallet as $key=>$vo): ?><tr>
										<td><?php echo ($vo["序号"]); ?></td>
										<td><?php echo ($vo["用户名"]); ?></td>
										<td><?php echo ($vo["银行名称"]); ?></td>
										<td><?php echo ($vo["银行卡号"]); ?></td>
										<td><?php echo ($vo["金额"]); ?></td>
										<td><?php echo ($vo["冻结金额"]); ?></td>		
										<td><?php if($vo['状态']==0){echo "冻结";}else if($vo['状态']==1){echo "激活";}?></td>

							...
							<div class="panel-body">
								<div class="form-group">
									...
									<select class="form-control" name="list">
                                            ...
                                            <option value="4" selected="selected">生成证券报单记录表</option>
                                          ...
                                          <!-- <input type="hidden" name="ta" value="12"></input>                                  -->
									</div>
									...
									<label class="col-sm-1 control-label" for="bankno">订单号</label>
									<div class="col-sm-1">
									       <input type="text" class="form-control" id="username" name="securitiesid" placeholder="请输入"  >
									</div>
									<label class="col-sm-1 control-label" for="username">订单状态</label>
									<div class="col-sm-1">
									<select class="form-control" name="status">
									       <option value="">请选择</option>
									       <option value="0">生成奖金</option>
									       <option value="1">已生成奖金</option>
									</select>
									</div>
									...
									<select class="form-control" name="field">
									      <option value="">请选择</option>
									      <option value="0">购买证券数量</option>
									      <option value="1">实际生成证券数量</option>
									      <option value="2">金额</option>
									      <option value="3">真实金额</option>
									      <option value="4">所得证券系数</option>
									      <option value="5">订单号</option>
									      <option value="6">冻结状态</option>
									</select>
									</div>
									...
									<label class="col-sm-1 control-label" for="bankno">下单时间</label>
									<div class="col-sm-2">
						...
						<table class="table table-striped table-bordered" cellspacing="0" width="100%">
							...
							<tbody>
                               <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
										...
										<td><?php echo ($vo["securitiesid"]); ?></td>
										<td><?php if($vo['status']==0){echo "生成奖金";}else if($vo['status']==1){echo "已生成奖金";}?></td>
										<td><?php echo ($vo["securities"]); ?></td>
										<td><?php echo ($vo["securitiesnum"]); ?></td>
										<td><?php echo ($vo["price"]); ?></td>
										<td><?php echo ($vo["realprice"]); ?></td>
										<td><?php echo ($vo["levered"]); ?></td>
										<td><?php echo ($vo["otime"]); ?></td>
										<td><?php echo ($vo["ctime"]); ?></td>
										<td><?php echo ($vo["remark"]); ?></td>
										<td><?php if($vo['frozen']==0){echo "未冻结";}else if($vo['frozen']==1){echo "冻结";}?></td>

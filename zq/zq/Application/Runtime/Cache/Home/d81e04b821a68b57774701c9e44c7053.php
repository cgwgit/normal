        ...
        <div class="panel panel-default">
            <form role="form" id="form" class="form-horizontal" enctype="multipart/form-data" name='fam' action="<?php echo U('Index/addGoods'); ?>" method="post">
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="field-1">培育佣金比例(%)：</label>
                        <div class="col-sm-3">
                            <input type="text" class="form-control" id="t_3" name="t_bred" value="">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="field-1">培育佣金比例浮动(%)：</label>
                        <div class="col-sm-3">
                            <input type="text" class="form-control" id="t_3" name="t_bred_f" value="">
                        </div>
                    </div>
                    <div class="form-group-separator"></div>
                    <div class="form-group">

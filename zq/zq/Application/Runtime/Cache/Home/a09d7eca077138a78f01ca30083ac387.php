            ...
            <table class="table table-striped table-bordered" cellspacing="0" width="100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $v['t_bred']; ?></td>
                        <td><?php echo $v['t_bred_f']; ?></td>
                        <td><?php echo $v['utime']; ?></td>
                        <td><a href="<?php echo U('Index/editGoods', array('goodsId'=>$v['id'])); ?>">[编辑]</a><a href="<?php echo U('Index/deleteGoods', array('goodsId'=>$v['id'])); ?>">[删除]</a></td>
                    </tr>
                    <?php }} ?>
                </tbody>
            </table>

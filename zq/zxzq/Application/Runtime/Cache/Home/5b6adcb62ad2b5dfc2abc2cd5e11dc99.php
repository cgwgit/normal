        ...
        <div class="login-container">
            <div class="row">
                ...
                <div class="col-sm-6">
                    ...
                    <form method="post" action="/index.php/Home/Login/login" class="login-form fade-in-effect">
						...
						<div class="info-links" align="right">
                            <a href="/index.php/Home/Change/index">忘记密码？</a> 
                        </div>
                        ...
                        <div class="login-footer">
                            还没有账户？<a href="/index.php/Home/Regist/index">立即注册</a> 
							<div class="info-links">
                                <a >中孝科技（北京）有限公司</a> -
                                <a >京ICP备16046744号</a>
                            </div>

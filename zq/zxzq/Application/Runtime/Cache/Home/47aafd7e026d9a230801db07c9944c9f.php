	...
	<div class="col-sm-9">
		<div class="panel panel-default">
			<div class="panel-heading">
				<div class="panel-title">用户档案查看</div>
<!--				<div class="panel-options">
					<a href="/index.php/Home/Index/accountProfile">
						<i class="fa-rotate-right"></i>&nbsp;&nbsp;编辑
					</a>
				</div>-->
			</div>
			<div class="panel-body">
				<form role="form" class="form-horizontal">
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="text" class="form-control" id="field-1" placeholder="<?php echo ($result["member_truename"]); ?>" disabled="true">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-1 control-label" for="field-1">身份证号</label>
						<div class="col-sm-6">
							<input type="text" class="form-control" id="field-1" placeholder="<?php echo ($result["member_idcard"]); ?>" disabled="true">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-1 control-label" for="field-1">手机号码</label>
						<div class="col-sm-6">
							<input type="text" class="form-control" id="field-1" placeholder="<?php echo ($result["member_mobile"]); ?>" disabled="true">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-6">
							<select class="form-control" disabled="true">
								<option value="<?php echo ($result["member_bankname"]); ?>"><?php echo ($result["member_bankname"]); ?></option>
							</select>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-6">
							<select class="form-control" disabled="true">
								<option value="<?php echo ($result["member_cardtype"]); ?>"><?php echo ($result["member_cardtype"]); ?></option>
							</select>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="text" class="form-control" id="field-1" placeholder="<?php echo ($result["member_bankcard"]); ?>" disabled="true">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-1 control-label" for="field-1">性别</label>
						<div class="col-sm-6">
                                                    <input type="text" class="form-control" id="field-1" placeholder="<?php if($result['member_sex']==0){echo '未填写'; }elseif($result['member_sex']==1){echo '男'; }elseif($result['member_sex']==2){echo '女'; }elseif($result['member_sex']==3){echo '保密'; } ?>" disabled="true">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-1 control-label" for="field-1">联系地址</label>
						<div class="col-sm-6">
							<input type="text" class="form-control" id="field-1" placeholder="<?php echo ($result["member_address"]); ?>" disabled="true">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-1 control-label" for="field-1">电子邮件</label>
						<div class="col-sm-6">
							<input type="text" class="form-control" id="field-1" placeholder="<?php echo ($result["member_email"]); ?>" disabled="true">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-1 control-label" for="field-1">注册日期</label>
						<div class="col-sm-6">
                                                    <input type="text" class="form-control" id="field-1" placeholder="<?php echo date('Y-m-d H:i:s',$result['member_time']); ?>" disabled="true">
						</div>
					</div>
				</form>
			</div>
...
<!--<div class="row">
	...
	<div class="col-sm-9">
		<div class="panel panel-default">
			<div class="panel-heading">
				<div class="panel-title">推广资讯</div>
			</div>
			<div class="panel-body">
				<form role="form" class="form-horizontal">
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="text" class="form-control" id="field-1" placeholder="<?php echo ($result["securities_id"]); ?>" disabled="true">
						</div>
					</div>
				</form>
			</div>

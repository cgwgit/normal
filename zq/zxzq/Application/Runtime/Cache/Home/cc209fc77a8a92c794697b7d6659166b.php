    ...
    <div class="panel-body">
        <form role="form" class="form-horizontal">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" name='name' id="field-1" value="<?php echo ($_SESSION['userData']['member_truename']); ?>">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-1 control-label" for="field-1">身份证号</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" name='idcard' id="field-1" value="<?php echo ($_SESSION['userData']['member_idcard']); ?>">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-1 control-label" for="field-1">手机号</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" name='mobile' id="field-1" value="<?php echo ($_SESSION['userData']['member_mobile']); ?>">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <select class="form-control" name='bankname'>
                        ...
                        <option <?php if($_SESSION['userData']['member_bankname']==$v['bank_name']) {echo "selected";}?>><?php echo $v['bank_name']; ?></option>
                        <?php } ?>
                    </select>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <select class="form-control" name='member_cardtype'>
                        <option <?php if($_SESSION['userData']['member_cardtype']=="储蓄卡") {echo "selected = 'selected'";}?>>储蓄卡</option>
                        <option <?php if($_SESSION['userData']['member_cardtype']=="信用卡") {echo "selected = 'selected'";}?>>信用卡</option>
                    </select>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" id="field-1" name='bankcard' value="<?php echo ($_SESSION['userData']['member_bankcard']); ?>">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <select class="form-control" name='sex'>
                        <option <?php if($_SESSION['userData']['member_sex']==0) {echo "selected = 'selected'";}?>>未填写</option>
                        <option <?php if($_SESSION['userData']['member_sex']==1) {echo "selected = 'selected'";}?>>男</option>
                        <option <?php if($_SESSION['userData']['member_sex']==2) {echo "selected = 'selected'";}?>>女</option>
                        <option <?php if($_SESSION['userData']['member_sex']==3) {echo "selected = 'selected'";}?>>保密</option>
                    </select>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" id="field-1" name='address' value="<?php echo ($_SESSION['userData']['member_address']); ?>">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-1 control-label" for="field-1">电子邮件</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" id="field-1" name='email' value="<?php echo ($_SESSION['userData']['member_email']); ?>" >
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-1 control-label" for="field-1">推荐人</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" id="field-1" name='inviter_id' value="<?php echo ($_SESSION['userData']['inviter_id']); ?>" readonly>
                </div>
            </div>
            <div class="form-group">

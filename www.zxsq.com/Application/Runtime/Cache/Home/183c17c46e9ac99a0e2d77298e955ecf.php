						...
						<form role="form" class="form-horizontal">
							<div class="panel-body">
								<div class="form-group">
									...
									<div class="col-sm-2">
										<input type="text" class="form-control" name="username" placeholder="请输入用户名" value="<?php echo ($name); ?>" >
									</div>
									<label class="col-sm-1 control-label" for="bankno">结算日期</label>
									<div class="col-sm-2">
                                                                            <input class="form-control datepicker" name="date" data-format="yyyy-MM-dd"  type="text" value="<?php if($date){echo $date;}else{echo date('Y-m-d');}?>">
									</div>
				...
				<div class="row">
					<div class="col-sm-3">                                
						<div class="xe-widget xe-counter">
							...
							<div class="xe-label">
									<strong class="num"><?php if($real_reward){echo $real_reward;}else{echo "0.00";} ?></strong>
									<span>当周贡献奖金</span>
							</div>
						</div>
					</div>
					<div class="col-sm-3">                                
						<div class="xe-widget xe-counter">
							...
							<div class="xe-label">
									<strong class="num"><?php if($reward){echo $reward;}else{echo "0.00";} ?></strong>
									<span>累计贡献奖金</span>
							</div>
						</div>
					</div>	
						...
						<table class="table table-striped table-bordered" cellspacing="0" width="100%">
							...
							<tbody>
								<?php if(isset($_GET['p'])){ $p=$_GET['p']; $i=1+10*($p-1); }else{ $i=1;} ?>
									...
									<td><?php echo ($vo["reward_amount"]); ?></td>

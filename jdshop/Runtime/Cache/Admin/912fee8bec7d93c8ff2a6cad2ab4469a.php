  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" id="general-tab-show">
    ...
    <tr>
      ...
      <select name="cat_pid">
        ...
        <?php if(is_array($catinfo)): foreach($catinfo as $key=>$at): ?><option value="<?php echo ($at["cat_id"]); ?>"><?php echo str_repeat('--/',$at['cat_level']); echo ($at["cat_name"]); ?></option><?php endforeach; endif; ?>
      </select>
      </div></td>
    </tr>
  </table>

...
<div class="crazy">
	<ul>
	<?php if(is_array($qiangInfo)): foreach($qiangInfo as $key=>$v): ?><li>
		<dl>
			<dt><a href=""><img src="<?php echo (SITE_URL); echo (substr($v["goods_small_logo"],2)); ?>" alt="" /></a></dt>
			<dd><a href=""><?php echo ($v["goods_name"]); ?></a></dd>
			<dd><span>售价：</span><strong> ￥<?php echo ($v["goods_shop_price"]); ?></strong></dd>
		</dl>
...
<!-- 疯狂抢购 end-->
	...
	<ul>
	<?php if(is_array($recInfo)): foreach($recInfo as $key=>$v): ?><li>
		<dl>
			<dt><a href=""><img src="<?php echo (SITE_URL); echo (substr($v["goods_small_logo"],2)); ?>" alt="" /></a></dt>
			<dd><a href=""><?php echo ($v["goods_name"]); ?></a></dd>
			<dd><span>售价：</span><strong> ￥<?php echo ($v["goods_shop_price"]); ?></strong></dd>
				...
				<div class="new none">
	<ul>
	<?php if(is_array($newInfo)): foreach($newInfo as $key=>$v): ?><li>
		<dl>
			<dt><a href=""><img src="<?php echo (SITE_URL); echo (substr($v["goods_small_logo"],2)); ?>" alt="" /></a></dt>
			<dd><a href=""><?php echo ($v["goods_name"]); ?></a></dd>
			<dd><span>售价：</span><strong> ￥<?php echo ($v["goods_shop_price"]); ?></strong></dd>

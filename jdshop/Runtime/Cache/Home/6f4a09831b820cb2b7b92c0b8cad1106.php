...
<link rel="stylesheet" href="<?php echo (CSS_URL); ?>fillin.css" type="text/css">
		...
		<div class="fillin_bd">
			...
			<div class="address">
				...
				<div class="address_select">
					<ul>
						<li class="cur">
							<input type="radio" name="cgn_id" checked="checked" value='131' />王超平 北京市 昌平区 建材城西路金燕龙办公楼一层 13555555555 
							<a href="">设为默认地址</a>
							<a href="">编辑</a>
							<a href="">删除</a>
						</li>
						<li>
							<input type="radio" name="cgn_id" value='132' />王超平 湖北省 武汉市  武昌 关山光谷软件园1号201 13333333333
							<a href="">设为默认地址</a>
							<a href="">编辑</a>
							<a href="">删除</a>
						</li>
				...
				<div class="delivery_select">
					<table>
						...
						<tbody>
							<tr class="cur">	
								<td>
									<input type="radio" name="shipping" checked="checked" value="0" />圆通
									<select name="" id="">
							...
							<tr>
								...
								<td><input type="radio" name="shipping"  value="1"/>申通</td>
								<td>￥40.00</td>
								<td>每张订单不满499.00元,运费40.00元, 订单4...</td>
							</tr>
							<tr>
								
								<td><input type="radio" name="shipping"  value="2"/>韵达</td>
								<td>￥40.00</td>
								<td>每张订单不满499.00元,运费40.00元, 订单4...</td>
							</tr>
							<tr>

								<td><input type="radio" name="shipping"  value="3"/>顺丰</td>
								<td>￥10.00</td>
								<td>每张订单不满499.00元,运费15.00元, 订单4...</td>
							</tr>
						</tbody>
			...
			<div class="pay">
				...
				<div class="pay_select">
					<table> 
						<tr class="cur">
							<td class="col1"><input type="radio" name="pay_method"
							value='0'  checked='checked'/>支付宝</td>
							<td class="col2">送货上门后再收款，支持现金、POS机刷卡、支票支付</td>
						</tr>
						<tr>
							<td class="col1"><input type="radio" name="pay_method" /value='1'>货到付款</td>
							<td class="col2">即时到帐，支持绝大数银行借记卡及部分银行信用卡</td>
						</tr>
						<tr>
							<td class="col1"><input type="radio" name="pay_method" value='2' />上门自提</td>
				...
				<div class="receipt_select">
						...
						<ul>
							<li>
								...
								<input type="radio" name="fapiao_title" checked="checked" class="personal" value='0' />个人
								<input type="radio" name="fapiao_title" class="company" value='1'/>单位
								<input type="text" name='fapiao_title_msg' class="txt company_input"  />
							</li>
							<li>
								<label for="">发票内容：</label>
								<input type="radio" name="fapiao_content" checked="checked" value="0" />办公用品
								<input type="radio" name="fapiao_content" value="1" />体育休闲
								<input type="radio" name="fapiao_content" value="2" />餐饮
								<input type="radio" name="fapiao_content" value="3" />耗材
							</li>
						</ul>						
...
<?php if(is_array($cartinfo)): foreach($cartinfo as $key=>$v): ?><tr>
	<td class="col1"><a href=""><img src="<?php echo (IMG_URL); ?>cart_goods1.jpg" alt="" /></a>  <strong><a href=""><?php echo ($v["goods_name"]); ?></a></strong></td>

...
<form action="/index.php/Home/Goods/showlist/cat_id/1/pai/jg/xu/desc" name="serarch" method="get" class="fl">
...
<?php if(empty($_GET['price_qujian'])): ?><dl>
	<dt>价格：</dt>
	<dd class="cur"><a href="">不限</a></dd>
	<?php if(is_array($qujian)): foreach($qujian as $key=>$v): ?><dd><a href="/index.php/Home/Goods/showlist/cat_id/1/pai/jg/xu/desc/price_qujian/<?php echo ($v); ?>"><?php echo ($v); ?></a></dd><?php endforeach; endif; ?>
</dl><?php endif; ?>
...
<?php if(!in_array(($v["attr_id"]), is_array($dian_attrids)?$dian_attrids:explode(',',$dian_attrids))): ?><dl>
	...
	<?php if(is_array($v["attr_val"])): foreach($v["attr_val"] as $key=>$vv): ?><dd><a href="/index.php/Home/Goods/showlist/cat_id/1/pai/jg/xu/desc/attr_id_<?php echo ($v["attr_id"]); ?>/<?php echo ($vv); ?>"><?php echo ($vv); ?></a></dd><?php endforeach; endif; ?>
</dl><?php endif; endforeach; endif; ?>

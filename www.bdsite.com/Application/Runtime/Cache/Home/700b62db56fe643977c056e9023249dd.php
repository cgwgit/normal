...
<!--                                        <li class="">
					...
					<li class="active opened active">
						...
						<ul>
							...
							<li ><a href="/svnzxsq/index.php/Home/Withdraw/apply"><span class="title">钱包提现</span></a></li>
							<li class="active"><a href="/svnzxsq/index.php/Home/Withdraw/txjl"><span class="title">提现记录</span></a></li>
						</ul>
					</li>
					<li class="">
...
<div class="page-title">
			...
			<div class="panel panel-default">
				<div class="row">
					<div class="col-md-10">
                                            <form role="form" class="form-horizontal" action='/svnzxsq/index.php/Home/Withdraw/txjl' method="get">
							<div class="panel-body">
								<div class="form-group">
									<label class="col-sm-1 control-label" for="">处理进度</label>
									<div class="col-sm-2">
											<select name='pdc_payment_state' class="form-control">
												<option <?php if($pdc_payment_state==''){ echo "selected='selected'";}?>>全部</option>
                                                                                                <option value='0' <?php if($pdc_payment_state=='0'){ echo "selected='selected'";}?> >提现申请中</option>
												<option value='1' <?php if($pdc_payment_state=='1'){ echo "selected='selected'";}?> >提现成功</option>
<!--												<option>确认收款</option>
												<option>提现撤销</option>
												<option>提现结束</option>-->
											</select>
										</div>
									<label class="col-sm-1 control-label" for="finishdate">申请日期</label>
									<div class="col-sm-3">
					...
					<table class="table table-striped table-bordered" cellspacing="0" width="100%">
						...
						<tbody>
							  <?php if(isset($_GET['p'])){ $p=$_GET['p']; $i=1+10*($p-1); }else{ $i=1;} ?>
								...
								<td><?php echo $i;$i++; ?></td>
                                                                <td><?php echo ($vo["pdc_bank_user"]); ?></td>
								<td><?php echo (date("Y-m-d H:i",$vo["pdc_add_time"])); ?></td>
								...
								<td><?php echo ($vo["pdc_bank_name"]); ?></td>
                                                                ...
                                                                <td><?php if($vo['pdc_payment_state'] ==0){echo '提现申请中';}else if($vo['pdc_payment_state'] ==1){echo '提现成功';} ?></td>

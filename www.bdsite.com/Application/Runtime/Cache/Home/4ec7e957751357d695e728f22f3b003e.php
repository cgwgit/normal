			...
			<div class="sidebar-menu-inner">		
				...
				<ul id="main-menu" class="main-menu">
					...
					<li class="has-sub">
						...
						<ul>
							<li><a href="jjsy_tjj.php"><span class="title">推荐奖金</span></a></li>
							<li><a href="jjsy_glj.php"><span class="title">管理奖金</span></a></li>
							<li><a href="jjsy_fhj.php"><span class="title">分红奖金</span></a></li>
							<li><a href="jjsy_flj.php"><span class="title">福利奖金</span></a></li>
			...
			<div class="page-title">
				...
				<div class="breadcrumb-env">
						<ol class="breadcrumb bc-1">
							<li>
								<a href="/baodan/index.php/Home/Index/index"><i class="fa-home"></i>首页</a>
							</li>
							<li class="active">
								<strong>我的团队</strong>
							</li>
			...
			<div class="panel panel-default">
				<div class="panel-body">
					<table class="table table-striped table-bordered" cellspacing="0" width="100%">
						...
						<tbody>
							<?php
 foreach ($userRec as $vo){ echo "<tr  style='1000px'>"; echo "<td>".$vo["userid"]."</td>"; echo "<td>".$vo['username']."</td>"; echo "<td>".$vo['intbalance']."</td>"; echo "<td>".$vo['mobile']."</td>"; echo "<td>".$vo['createtime']."</td>"; echo "</tr>"; } ?>

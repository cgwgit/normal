...
<!--                                        <li class="">
					...
					<li class="active opened active">
						...
						<ul>
							...
							<li class="active"><a href="/svnzxsq/index.php/Home/Withdraw/record"><span class="title">转账记录</span></a></li>
						...
						<form role="form" class="form-horizontal">
							<div class="panel-body">
								<div class="form-group">
									<label class="col-sm-1 control-label" for="finishdate">转出日期</label>
									<div class="col-sm-2">
                                                                            <input type="text" id="finishdate" name="date" class="form-control daterange" data-format="YYYY-MM-DD" data-start-date="<?php echo date('Y-m-d H:i:s' )?>" data-end-date="<?php echo date('Y-m-d H:i:s' )?>" data-separator=" 至 " value="<?php echo ($date); ?>">
									</div>
									<label class="col-sm-1 control-label">转出账户：</label>
									<div class="col-sm-2">
					...
					<table class="table table-striped table-bordered" cellspacing="0" width="100%">
						...
						<tbody>
							...
							<?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
                                        <td><?php echo $i; $i++?></td>
								<td><?php if($vo['roll_out']==1){echo "奖金";} ?></td>
								<td><?php if($vo['roll_inot']==2){echo "消费积分";}else if($vo['roll_inot']==3){echo "中孝钱包";} ?></td>
								<td><?php echo number_format($vo['transfer_points'],2);?></td>
								<td><?php echo number_format($vo['poundage'],2);?></td>
								<td><?php echo number_format($vo['actual_number'],2);?></td>
								<td><?php echo ($vo["dateandtime"]); ?></td>
								<td><?php echo ($vo["remark"]); ?></td><?php endforeach; endif; ?>
						</tbody>
					</table>
				</div>

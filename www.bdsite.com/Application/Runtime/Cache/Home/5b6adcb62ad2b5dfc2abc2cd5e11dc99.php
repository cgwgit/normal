	...
	<div class="login-container">
		<div class="row">
			<div class="col-sm-6">
				...
				<form method="post" name="frm"  class="login-form fade-in-effect" action="/index.php/Home/Login/login" onsubmit=" return checkLogin()">
					...
					<div class="form-group">
						...
						<a href="/index.php/Home/Regist/index"><span>立即注册</span></a>
					<a href="/index.php/Home/Change/index" style='color:red'><span>找回密码？</span></a>

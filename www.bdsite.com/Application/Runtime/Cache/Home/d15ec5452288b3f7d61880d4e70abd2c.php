...
<!--                                        <li class="">
					...
					<li class="active opened active">
						...
						<ul>
							...
							<li class="active"><a href="/zxsq/index.php/Home/Wallet/consume"><span class="title">消费积分</span></a></li>
						</ul>
					</li>
					<li class="has-sub">
						<a href="">
...
<div class="page-title">
				...
				<div class="breadcrumb-env">
                        ...
                        <div class="row">
                        <div class="col-sm-2">
                                    <a href="/beifen/index.php/Home/Wallet/consume">
				...
				<div class="panel-body">
					<table class="table table-striped table-bordered" cellspacing="0" width="100%">
						...
						<tbody>
                                                    ...
                                                    <?php if(is_array($rcb)): foreach($rcb as $key=>$vo): ?><tr>
								<td><?php echo $i;$i++; ?></td>
								<td><?php echo (date("Y-m-d H:i",$vo["add_time"])); ?></td>
                                                                <td><?php echo ($vo["available_amount"]); ?></td>

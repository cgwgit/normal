...
<html lang="en">
    <head>
        ...
        <style>
            ...
            span.error{
                font:13px Arial;
                margin: 0 0 0 5px;
                background:url('/zxsq/Public/images/error.gif') no-repeat left center;
                padding: 0 0 0 15px;
            }
            span.right {
                font:13px Arial;
                margin: 0 0 0 5px;
                background:url('/zxsq/Public/images/right.gif') no-repeat left center;
                padding: 0 0 0 15px;
            }
        </style>
    ...
    <body class="page-body skin-white ">
                ...
                <div class="page-title">
                    ...
                    <div class="breadcrumb-env">
                        <ol class="breadcrumb bc-1">
                            <li>
                                <a href="/zxsq/index.php/Home/Login/index"><i class="fa-home"></i>返回登录</a>
                            </li>
                        </ol>	
                    </div>
                </div>
		...
		$.ajax( {  
		url:'/zxsq/index.php/Home/Code/code',// 跳转到 action  
		data:{ phone:mobile, 
				code:code
		},  
		type:'post',  
...
document.getElementById("btn").onclick=function(){
		...
		$.ajax( {  
		url:'/zxsq/index.php/Home/Code/pwd',// 跳转到 action  
		data:{ mobile:mobile 
      ...
      function ff() {
			 ...
			 function fff() {
				...
				$.ajax( {  
		url:'/zxsq/index.php/Home/Regist/res',// 跳转到 action  

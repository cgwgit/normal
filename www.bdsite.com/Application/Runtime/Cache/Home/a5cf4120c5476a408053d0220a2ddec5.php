...
<!--                                        <li class="">
					...
					<li class="active opened active">
						...
						<ul>
							...
							<li><a href="/zxsq/index.php/Home/Wallet/integral"><span class="title">中孝积分</span></a></li>
                                                          <li><a href="/zxsq/index.php/Home/Money/running"><span class="title">我的奖金</span></a></li>
							<li class="active"><a href="/zxsq/index.php/Home/Money/index"><span class="title">累计奖励收益</span></a></li>
                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                    <div class="xe-widget xe-counter">
                                        ...
                                        <div class="xe-label">
                                                <strong class="num"><?php if($jiangjin!=NULL){ echo $jiangjin;}else{ echo 0;}?></strong>
                                                <span>累计奖励收益</span>
                                        </div>
                                    </div>
                            </div>
                             <div class="col-sm-3">
                                    <div class="xe-widget xe-counter">
                                        ...
                                        <div class="xe-label">
                                                <strong class="num"><?php if($benzhou!=NULL){ echo $benzhou;}else{ echo 0;}?></strong>
                                                <span>本周累计奖金收益</span>
                                        </div>
                                    </div>
                            </div>
				...
				<div class="panel-body">
					<table class="table table-striped table-bordered" cellspacing="0" width="100%">
						...
						<tbody>
								...
								<td><?php echo ($vo["inviterid_leval"]); ?></td>
								<td><?php echo ($vo["reward_remark"]); ?></td>

					...
					<li class="active opened active">
						...
						<ul>
							...
							<li><a href="/zxsq/index.php/Home/Wallet/integral"><span class="title">中孝积分</span></a></li>
                                                        <li class="active"><a href="/zxsq/index.php/Home/Money/running"><span class="title">我的奖金</span></a></li>
				...
				<div class="panel-body">
					<table class="table table-striped table-bordered" cellspacing="0" width="100%">
						...
						<tbody>
                                                    ...
                                                    <?php if(is_array($running)): foreach($running as $key=>$vo): ?><tr>
								<td><?php echo $i;$i++; ?></td>
								<td><?php echo ($vo["dateandtime"]); ?></td>
                                                                <td><?php echo ($vo["transfer_points"]); ?></td>
								<td><?php echo ($vo["actual_number"]); ?></td>
                                                                <td><?php echo ($vo["manage"]); ?></td>
                                                                <td><?php echo ($vo["poundage"]); ?></td>
								<td><?php echo ($vo["consumption"]); ?></td>
								<td><?php echo ($vo["charitable"]); ?></td>

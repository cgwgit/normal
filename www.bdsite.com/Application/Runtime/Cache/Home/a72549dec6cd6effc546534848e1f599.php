			...
			<div class="col-sm-6">
									...
									success: function(resp)
									{
										show_loading_bar({
											...
											finish: function(){
												...
												{
													window.location.href = '/zxsq/index.php/Home/Index/index';
												}
																						}
										});
				...
				<form method="post" name="frm"  class="login-form fade-in-effect" action="" ">
					<div class="login-header">
						<a  class="logo">
							<img src="/zxsq/Public/assets/images/logo-white-bg@2x.png" alt="" width="80" />
							<span>找回密码</span>
						</a>
					...
					<a href="/zxsq/index.php/Home/Login/index"><span>返回登录</span></a>
						<a href="/zxsq/index.php/Home/Regist/index"><span>立即注册</span></a>
...
$.ajax( {  
		url:'/zxsq/index.php/Home/Change/chaxun',// 跳转到 action  
		data:{ name:name, 
		},  
		type:'post',  
		dataType:'json',  
...
document.getElementById("btn").onclick=function(){
		...
		//alert(name);
		$.ajax( {  
		url:'/zxsq/index.php/Home/Change/pwd',// 跳转到 action  
		data:{ name:name 
 ...
 function checkcode(){
	...
	$.ajax( {  
		url:'/zxsq/index.php/Home/Change/check',// 跳转到 action  
		data:{ name:name, 
				code:code
		},  
		type:'post',  
	...
	$.ajax( {  
		url:'/zxsq/index.php/Home/Change/sure',// 跳转到 action  
		data:{ name:name, 
				password:password
		},  
		type:'post',  
		...
		if(result.code==0){
		alert(result.message);
		location.href="/zxsq/index.php/Home/Login/index";
		}else{
		alert(result.message);
		}
	...
	<script src="/zxsq/Public/assets/js/jquery-validate/jquery.validate.min.js"></script>
	<script src="/zxsq/Public/assets/js/toastr/toastr.min.js"></script>
